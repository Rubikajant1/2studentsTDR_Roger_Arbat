...
from web_2Students.pages.front.front_subjects import mobile_subjects_selector
from web_2Students.pages.front.calendar import calendar_for_mobile
...
# Funció front-end
def mobile_student_coach() -> rx.Component:
    return rx.box(
        navbar(),
        rx.mobile_only(
            rx.center(
            ...
            rx.box(
                rx.card(
                    rx.box(
                        ...
                        rx.hstack(
                            rx.input(placeholder='10', max_length=2, required=True, width='13%',on_change=NewCoach.set_price),
                            rx.heading("€"),
                            padding_bottom ='1em'
                        ),
                        rx.menu.root(
